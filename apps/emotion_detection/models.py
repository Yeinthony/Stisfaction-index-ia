...
class Expretions(models.Model):
    ...
    day = models.IntegerField('Dia', null=False, blank=False)
    week = models.IntegerField('Semana', null=False, blank=False)
    month = models.IntegerField('Mes', null=False, blank=False)
    ...
    def __str__(self) -> str:
        return f'registrado el: {self.day}/{self.month}/{self.year}, por {self.user.username}'
