...
from apps.emotion_detection.models import Ages
from apps.emotion_detection.api.serlializer import AgesSerializer 

class AgesViewSet(viewsets.ModelViewSet):
    serializer_class = AgesSerializer  
    queryset = AgesSerializer.Meta.model.objects.all()
