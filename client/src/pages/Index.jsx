...
export function Index() {
    return (
        <div className="bg-gray-dark border-2 border-gray-dark sm:h-auto lg:h-screen">
            <SecondaryNavbar/>
            <div>
                <section className="md:z-0">
                    <div className="mx-16">
                        <div className="w-7/12 my-24 p-6 rounded-lg dark:bg-gray-800 dark:border-gray-700">
